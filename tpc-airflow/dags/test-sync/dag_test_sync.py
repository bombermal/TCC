...
default_args = {
    "owner": "sync",                     #Proprietário da DAG
...
DAG_NAME = "dag_test_sync"
DAG_DESCRIPTION = "DAG registro de tempo de desenvolvimento"
# File path
NB_TPC = "/opt/airflow/dags/test-sync/spark_jobs/test_sync.ipynb"
